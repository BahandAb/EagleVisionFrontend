...
function takeSnapshot() {
    ...
    // 1. Draw Feed (Video or Photo) - CLEAN
    if (isPhotoMode) {
    ...
    // This ensures that if you broadcast this later, it doesn't have "burned in" lines
...
function enterLiveMode() {
    ...
    statusTag.innerText = "● LIVE"; statusTag.style.display = "block"; statusTag.style.background = "#ff4444";
...
function startConnection() {
    ...
    socket.on("offer", async (sdp) => {
        ...
        peerConnection.ontrack = (event) => { if(!isPhotoMode) { statusTag.style.display = "block"; statusTag.innerText = "● LIVE"; statusTag.style.background = "#ff4444"; } videoEl.srcObject = event.streams[0]; setTimeout(resizeCanvas, 500); };
